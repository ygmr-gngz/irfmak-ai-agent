(function () {
  ...
  style.textContent = `
    ...
    .irfmak-widget .chat-header-title {
      font-size: 18px;
      font-weight: 700;
      margin-bottom: 4px;
    }

    .irfmak-widget .chat-header-subtitle {
      font-size: 12px;
      opacity: 0.92;
      max-width: 270px;
      line-height: 1.4;
    ...
    .irfmak-widget .message-wrapper.user {
      align-items: flex-end;
    }

    .irfmak-widget .message-wrapper.bot {
      align-items: flex-start;
    }
    ...
    .irfmak-widget .chat-form {
      ...
      gap: 10px;
      padding: 14px;
      border-top: 1px solid var(--irfmak-border);
      background: #fff;
    }
  ...
  root.innerHTML = `
    <div id="irfmak-welcome-card" class="welcome-card">
      ...
      <div class="welcome-text">
        Merhaba, ben İrfmak Yapay Zeka Robotuyum, size yardımcı olabilir miyim?
      </div>
      <button id="irfmak-open-chat-btn" class="welcome-open-btn" type="button">
        Sohbeti Başlat
      </button>
    </div>
